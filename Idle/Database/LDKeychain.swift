...
public class LDKeychain: NSObject {
...
public class LDKeychainManager: NSObject {
    // TODO: 创建查询条件
    ...
    class func keyChainSaveData(data:Any ,withIdentifier identifier:String) -> Bool {
        ...
        // 设置数据
        do {
            try keyChainSaveMutableDictionary.setValue(NSKeyedArchiver.archivedData(withRootObject: data, requiringSecureCoding: true), forKey: kSecValueData as String)
    ...
    class func keyChainUpdate(data:Any ,withIdentifier identifier:String) -> Bool {
        ...
        // 设置数据
        do {
            try updateMutableDictionary.setValue(NSKeyedArchiver.archivedData(withRootObject: data, requiringSecureCoding: true), forKey: kSecValueData as String)
    ...
    // TODO: 删除数据
    class func keychainDelete(identifier:String) {
        // 获取删除的条件
